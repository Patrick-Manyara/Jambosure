                ...
                <form method="post" id="quickForm" enctype="multipart/form-data" action="<?= model_url ?>simple&table=voucher&url=view_vouchers">
                    <div class="card-body">
                        <div>
                            ...
                            input_select_array("Link to Firm(optional)?", "company_id", $voucher, $required, $companys);
                            ?>
                             <input hidden name="voucher_added_by" value="admin" />
                            <input hidden name="voucher_for" value="company" />
                        </div>
